...
#### 🕹️ Animações de contribuições no GitHub

##### 👾 Pac-Man Contribution Graph
- [Pac-Man Contribution Graph - Abozanona](https://github.com/abozanona/pacman-contribution-graph/)
- [Pac-Man Contribution Graph Demo](https://abozanona.github.io/pacman-contribution-graph/)

##### 🐍 Snake Contribution Graph
- [Generate Snake Game from GitHub Contribution Grid - GitHub Marketplace](https://github.com/marketplace/actions/generate-snake-game-from-github-contribution-grid)
...
git remote add origin https://github.com/analorens/analorens.git  # Adiciona repositório remoto
git remote set-url origin https://github.com/analorens/analorens.git # Atualiza URL remota

# Enviando para o GitHub
git push -u origin main          # Envia o branch 'main' e define como upstream

# Clonando repositório existente
git clone https://github.com/analorens/analorens.git
